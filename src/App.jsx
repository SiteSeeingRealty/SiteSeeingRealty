    ...
    <section className="property-explorer" id="properties">
      ...
      <div className="holder">
        <div className="filters">
          {['All', 'Villa', 'Apartment', 'Plot'].map(f => (
          ...
          {filtered.map(p => (
            <div className="property-card" key={p.id}>
              ...
              <div className="property-info">
                ...
                <a href={`https://www.google.com/maps/search/?api=1&query=${p.lat},${p.lng}`} target="_blank" rel="noreferrer" className="link-flash" style={{fontSize: '14px', marginTop: '10px', display: 'inline-block'}}>Open in Google Maps</a>
              </div>
            </div>
          ))}
        </div>
    ...
    <>
      ...
      <div id="wrapper">
        ...
        <Routes>
          ...
          <Route path="/dashboard74927" element={<Dashboard />} />
